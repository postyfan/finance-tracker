...
public class Budget {
    ...
    public Budget(String category, double limit) {
        // Initialize category and limit
        // Initialize spent to 0.0
    ...
    public double getRemaining() {
        // Calculate and return: limit - spent
        return limit - spent;
    }
    ...
    public boolean isOverBudget() {
        // Return true if spent > limit, false otherwise
        return spent > limit;
    }
    
    public boolean isNearLimit() {
        // Return true if spent >= 80% of limit
    ...
    public String toString() {
        // Return a formatted string showing budget info
